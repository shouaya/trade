...
const ROLLING_POOL_DETAILS_DDL = `
  CREATE TABLE IF NOT EXISTS ${ROLLING_POOL_DETAILS_TABLE} (
    id INT AUTO_INCREMENT PRIMARY KEY,
    ...
    CONSTRAINT fk_rolling_pool_details_config_id FOREIGN KEY (config_id) REFERENCES ${TRAIN_CONFIGS_TABLE}(id) ON DELETE CASCADE
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
`;

const ROLLING_RULE_DETAILS_DDL = `
  CREATE TABLE IF NOT EXISTS ${ROLLING_RULE_DETAILS_TABLE} (
    id INT AUTO_INCREMENT PRIMARY KEY,
    config_id INT NOT NULL,
    ...
    CONSTRAINT fk_rolling_rule_details_config_id FOREIGN KEY (config_id) REFERENCES ${TRAIN_CONFIGS_TABLE}(id) ON DELETE CASCADE
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
`;
