...
```bash
node scripts/generate-strategy-group-scripts.js
```

输出: `run-backtest-2025-group01.js` ~ `run-backtest-2025-group10.js`
...
### 核心脚本
- `run-backtest-2025-strategy-group-template.js` - 策略组回测模板
- `generate-strategy-group-scripts.js` - 生成10个组脚本
- `run-backtest-2025-group01.js` ~ `run-backtest-2025-group10.js` - 10个组脚本
...
# 单独重新运行该组
node scripts/run-backtest-2025-group03.js
```
