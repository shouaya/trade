...
// ========== 配置项 (由启动脚本替换) ==========
const MONTH_NUMBER = {{MONTH_NUMBER}};  // 月份: 1-12
const MONTH_STR = '{{MONTH_STR}}';      // 月份字符串: '01'-'12'
const START_DATE = '{{START_DATE}}';    // 开始日期: '2025-01-01'
const END_DATE = '{{END_DATE}}';        // 结束日期: '2025-01-31'
const TABLE_SUFFIX = '{{TABLE_SUFFIX}}'; // 表后缀: '2025_01'
// =============================================
