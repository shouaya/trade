...
// ========== 配置项 (由启动脚本替换) ==========
const MONTH_NUMBER = 3;  // 月份: 1-12
const MONTH_STR = '03';      // 月份字符串: '01'-'12'
const START_DATE = '2025-03-01';    // 开始日期: '2025-01-01'
const END_DATE = '2025-03-31';        // 结束日期: '2025-01-31'
const TABLE_SUFFIX = '2025_03'; // 表后缀: '2025_01'
// =============================================
